...
- [skatkov/miniflux-email-updates](https://github.com/skatkov/miniflux-email-updates) - Miniflux client that deliveres updates to email. 90% of this code is generated by ChatGPT (4 weeks ago) 
