...
- [skatkov/miniflux-email-updates](https://github.com/skatkov/miniflux-email-updates) - (WIP) Miniflux client that deliveres updates to email. 90% of this code is generated by ChatGPT (1 week ago) 
